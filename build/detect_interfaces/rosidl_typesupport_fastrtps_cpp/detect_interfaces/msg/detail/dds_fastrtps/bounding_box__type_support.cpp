...
#include "detect_interfaces/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = detect_interfaces::msg::BoundingBox;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const detect_interfaces::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<detect_interfaces::msg::BoundingBox *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_detect_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<detect_interfaces::msg::BoundingBox>()
{
  return &detect_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
