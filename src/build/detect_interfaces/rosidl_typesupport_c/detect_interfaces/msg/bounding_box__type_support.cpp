...
#include "detect_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _BoundingBox_type_support_symbol_names_t _BoundingBox_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, detect_interfaces, msg, BoundingBox)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, detect_interfaces, msg, BoundingBox)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_detect_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, detect_interfaces, msg, BoundingBox)() {
  return &::detect_interfaces::msg::rosidl_typesupport_c::BoundingBox_message_type_support_handle;
}
